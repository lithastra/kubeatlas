...
[roadmap](./roadmap.md). Authentication is still your job — read
the [security warning](./installation/security-warning.md) before
exposing the UI.
...
[longer-term roadmap](./roadmap.md#beyond-phase-3-sketch).
